...
- Nginx passa a servir assets compilados em `src/public/static`, arquivos estaticos versionados em `src/static` e dependencias npm montadas em `node_modules`, corrigindo imagens e scripts quebrados em clones limpos.
